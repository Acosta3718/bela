...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/bela/public/ventas/crear" class="btn btn-primary">Nueva</a>
</div>
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-end">
                <a class="btn btn-sm btn-secondary" href="/bela/public/ventas/editar?id=<?= $venta['id'] ?>">Editar</a>
                <form action="/bela/public/ventas/eliminar?id=<?= $venta['id'] ?>" method="post" class="d-inline">
                    <button class="btn btn-sm btn-danger" onclick="return confirm('¿Eliminar venta?')">Eliminar</button>
                </form>
                <form action="/bela/public/ventas/cobro?id=<?= $venta['id'] ?>" method="post" class="d-inline">
